    ...
    <form class="admin-formulario" id="formulario-faqs" action="{{ route('faqs_store') }}" autocomplete="off">
        ...
        <div class="formulario-contenido-item" id="item-titulo">
            ...
            <div class="formulario-contenido-item-campo">
                ...
                <input type="text" class="formulario-contenido-item-campo-titulo" id="formulario-contenido-item-campo"
                    name="titulo" placeholder="Inserta la pregunta"
        ...
        <div class="formulario-contenido-item" id="item-descripcion">
            ...
            <div class="formulario-contenido-item-campo">
                <textarea type="text" name="description" class="formulario-contenido-item-campo-descripcion ckeditor"
...
@section('table')
    ...
    <div class="tabla-contenedor">
        <div class="admin-tabla" id="tabla-faqs">
            <div class="admin-tabla-encabezado">
                <div class="admin-tabla-columna columna-id" >Id</div>
                <div class="admin-tabla-columna columna-titulo">Título</div>
                {{-- <div class="admin-tabla-descripcioncolumna">Descripción</div> --}}
                <div class="admin-tabla-columna columna-categoria">Categoria</div>
            </div>


            <div class="admin-tabla-contenido content">
                @foreach ($faqs as $faq)
                    <div class="swipe-element ">
                        <div class="admin-tabla-contenido-fila swipe-front promote-layer">
                            <div class="admin-tabla-columna columna-id">{{ $faq->id }}</div>
                            <div class="admin-tabla-columna columna-titulo">{{ $faq->titulo }}</div>
                            {{-- <div class="admin-tabla-descripcioncolumna">{{$faq->description}}</div> --}}
                            <div class="admin-tabla-columna columna-categoria">{{ $faq->category->nombre }}</div>

                        </div>

                        <div class="swipe-back swipe-delete" id="swipe-delete"
                        ...
                        <div class="swipe-back swipe-edit" id="swipe-edit"
