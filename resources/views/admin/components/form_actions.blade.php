@isset($create)
    <div class="formulario-tab-item-action" id= "crear">
        <div 
            class="formulario-tab-item-boton" 
            id="boton-crear"
            data-url="{{route($route.'_create')}}">
...
@isset($visible)
    <div class="formulario-tab-item-action visible-checkbox">
        <div class="formulario-tab-item-switch" >
            <input 
            type="checkbox" 
            name="visible" 
            value="{{ isset($route->visible) ? $route->visible : '1' }}" 
            id="checkbox-visible" 
            checked>
