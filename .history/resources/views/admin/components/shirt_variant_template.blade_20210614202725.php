...
<div
class="variant-item_active variant-template "
data-tag="variant-item"
>
    <form
    class="form-variant-item admin-form"
    ...
    autocomplete="off">
        ...
        <input type="hidden" name="product[specific][id]" value="{{isset($product->id) ? $product->id : ''}}"/>

        <input type="hidden" name="product[group]" value="{{isset($productGroup->id) ? $productGroup->id : ''}}"/>

        <input type="hidden" name="product[specific][model]" value="{{isset($shirtModel->id) ? $shirtModel->id : ''}}">
        ...
        <div class="form-group">
            ...
            <div class="form-input">
                    <select name="product[specific][col][color_id]" >
                        <option hidden selected>-- Color --</option>
                        @foreach ($colors as $color)
                            <option value="{{ $color->id }}"
        ...
        <div class="form-group">
            ...
            <div class="form-input">
                <select name="product[specific][col][size_id]">
                    <option hidden selected>-- Talla --</option>
                    @foreach ($sizes as $size)
                        <option value="{{ $size->id }}"
                            @isset($shirt)
